...
public class EmployeeController {
    ...
    @HystrixCommand(fallbackMethod = "fallbackResponseStudent")
    ...
    public String fallbackResponseStudent(int employeeid) {
        return "message : Service is down. Please try after sometime";
    }
